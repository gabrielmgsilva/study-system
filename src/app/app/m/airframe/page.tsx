...
const fileMap: Record<string, RawQuestion[]> = {
  '11.json': q11 as RawQuestion[],
  '12.json': q12 as RawQuestion[],
  '13.json': q13 as RawQuestion[],
  '14.json': q14 as RawQuestion[],
  '15.json': q15 as RawQuestion[],
  '16.json': q16 as RawQuestion[],
  '17.json': q17 as RawQuestion[],
  '18.json': q18 as RawQuestion[],
  '19.json': q19 as RawQuestion[],
  '20.json': q20 as RawQuestion[],
  '21.json': q21 as RawQuestion[],
  '22.json': q22 as RawQuestion[],
  '23.json': q23 as RawQuestion[],
  '24.json': q24 as RawQuestion[],
  '25.json': q25 as RawQuestion[],
  '26.json': q26 as RawQuestion[],
  '27.json': q27 as RawQuestion[],
  '28.json': q28 as RawQuestion[],
  '29.json': q29 as RawQuestion[],
  '30.json': q30 as RawQuestion[],
};
