...
import { ArrowLeft, ArrowRight, BookOpen, Wrench } from 'lucide-react';
...
export default function SHubPage() {
  const items: HubItem[] = [
    {
      id: 'sp',
      name: 'S – Standard Practices',
      desc: 'Core practices (01–12): drawings, hardware, corrosion, NDT, tools, servicing, and maintenance procedures.',
      href: ROUTES.sStandardPractices,
    },
    {
      id: 'rating',
      name: 'S Rating – Structures',
      desc: 'Structures rating (13–20): sheet metal, tubular, wood/fabric, composites, corrosion, NDT, fluid lines and thermoplastics.',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Button asChild variant="outline" size="sm" className={outlineBtn}>
          <Link href={ROUTES.s} className="flex items-center gap-2">
